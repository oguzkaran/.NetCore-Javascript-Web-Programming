...
public class PostalCodeAppService {
    ...
    public PostalCodesDTO findPostalCodeInfoByPostalCode(int postalCode)
    {
        return m_postalCodeInfoMapper.toPostalCodes(m_postalCodeServiceHelper.existsPostalCodeById(postalCode) ? getPostalCodes(postalCode)
