...
namespace PostalCodeServiceGeoNames
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "PostalCodeServiceGeoNames", Version = "v1" });
            });
            ...
            services
                .AddHttpClient()
                .AddSingleton<PostalCodeClient>()
                .AddSingleton<PostalCodeAppDbContext>()
                .AddSingleton(typeof(IPostalCodeRepository), typeof(PostalCodeRepository))
                .AddSingleton<IPostalCodeRepository, PostalCodeRepository>()
                .AddSingleton<PostalCodeAppDataHelper>()
                .AddSingleton<PostalCodeAppService>()
