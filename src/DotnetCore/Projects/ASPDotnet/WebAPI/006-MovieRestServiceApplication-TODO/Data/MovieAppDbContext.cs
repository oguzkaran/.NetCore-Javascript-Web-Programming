...
namespace CSD.MovieRestServiceApplication.Data
{
    public partial class MovieAppDbContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer("Server = aws-mssql.cct1ehgoywdp.us-east-2.rds.amazonaws.com; Database = DCJSWPA21_MoviesAppDb; User Id = admin; Password = csystem1993;");
        }
